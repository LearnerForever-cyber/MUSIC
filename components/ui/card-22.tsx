...
export const PlaceCard = ({
    ...
    // Filter out invalid images that might cause Next.js Image to crash
    ...
    const displayImages = sanitizedImages.length > 0
        ? sanitizedImages
    ...
    return (
        <motion.div
            ...
            className={cn(
                'flex h-full w-full max-w-sm flex-col overflow-hidden rounded-2xl border bg-card text-card-foreground shadow-lg cursor-pointer',
                className
            )}
        >
            ...
            {/* Content Section */}
            <motion.div variants={contentVariants} className="flex flex-1 flex-col p-5 space-y-4">
